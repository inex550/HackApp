...
val cities = listOf(
    Campus(
        ...
        55.755826,
        37.6172999,
        "Moscow is the capital and largest city of Russia, with a population of over 12 million people. It is known for its iconic landmarks such as Red Square, Saint Basil's Cathedral, and the Kremlin"
    ),
    Campus(
        "Saint Petersburg",
        59.9342802,
        30.3350986,
        "St. Petersburg is a city in Russia located on the Neva River. It is known for its beautiful architecture, historic landmarks, and rich cultural heritage."
    ),
    Campus(
        "Kazan",
        55.790278,
    ...
    Campus(
        ...
        55.0083525,
        82.9357327,
        "Novosibirsk is a city in Siberia, Russia, and is the third-most populous city in the country. It is known for its science and technology institutes, as well as its vibrant arts and culture scene."
    ),
    ...
    Campus(
        ...
        52.53631527349462,
        85.19421625737692,
        "Общежитие АГГПУ имени В.М. Шукшина. Ek. Короленко. Улица Короленко"
    ),
    Campus("Москва", 52.53631527349462, 85.19421625737692, "Общежитие  №1"),
    Campus("Барнаул", 53.34730609398818, 83.78555841306665, "Общежитие АлтГТУ №1"),
    Campus("Курган", 55.43539999433309, 65.3433536315165, "Общежитие КГУ №1"),
